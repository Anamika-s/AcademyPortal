using AcademyPortalBAL;
using AcademyPortalDAL;
using AdminBoLayer;
...
namespace AdminBlLayer
{
    public class AdminLogic
    {
        AcademyPortalDAL.AdminContext db = new AcademyPortalDAL.AdminContext();
        ...
        public string UpdateBatch(Batch batch,int userId)
        {
            ...
            else if(batch.BatchCapacity > batch.AssignedEmployees && emp.BatchId==null)
            {
                ...
                AcademyPortalDAL.EmployeeDbContext empDb = new AcademyPortalDAL.EmployeeDbContext();
